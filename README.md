...
This project is a backend for a hypothetical social media app, where which manages users’ accounts as well as any messages that they submit to the application. The application functions as a microblogging or messaging app. In this hypothetical application, any user should be able to see the messages posted to the site, or they can see the messages posted by a particular user. In either case, the backend will be able to deliver the data needed to display this information as well as process actions like logins, registrations, message creations, message updates, and message deletions.

## Database Tables

These are provided in the SQL script, and a ConnectionUtil class that will run the SQL script is provided:
