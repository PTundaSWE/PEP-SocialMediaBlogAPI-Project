package org.paul.restlearning.model;

public class Message {
    // An id for this message which will be automatically generated by the database.
    public int message_id;
    // The id for the user who has posted this message. We will assume that this is provided by the front-end of
    // this application.
    ...
    // When retrieving a message from the database, all fields will be needed. In that case, a constructor
    // with all fields is needed.
    // @param message_id
    // @param posted_by
    // @param message_text
    // @param time_posted_epoch
